RSpec.describe Truepill::Resources::Patient do
  ...
  context 'list patients - first result' do
    ...
    subject { Truepill::Resources::Patient.new.list(params).data.first }
  ...
  context 'create a patient' do
    ...
    subject { Truepill::Resources::Patient.new.create(attributes).data }
  ...
  context 'read a patient' do
    ...
    subject { Truepill::Resources::Patient.new.read(attributes[:id]).data }
  ...
  context 'update partial a patient' do
    ...
    subject { Truepill::Resources::Patient.new.update(id, attributes).data }

RSpec.describe Truepill::Authentication do
  ...
  context 'with invalid credentials' do
    ...
    it 'raises an exception' do
      expect { subject.access_token }.to raise_error(::Truepill::AuthError)
    end
  end
  ...
  context 'with token persistence' do
    ...
    before do
      ...
      Truepill.configuration.persist_token.call(old_token)
    end
